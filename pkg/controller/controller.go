...
import (
	...
	ctrlmetrics "github.com/erkanzileli/kotification/pkg/controller/metrics"
...
type Controller struct {
	...
	// ResourceGVK is the resource controller watches
	ResourceGVK schema.GroupVersionKind

	// Manager is the manager of the controller
...
func NewUnmanaged(mgr manager.Manager, gvk schema.GroupVersionKind, options Options) (*Controller, error) {
	...
	return &Controller{
		...
		MakeQueue: func() workqueue.RateLimitingInterface {
			return workqueue.NewNamedRateLimitingQueue(options.RateLimiter, gvk.String())
		},
...
func (c *Controller) Start(ctx context.Context) error {
	...
	resourceEventHandlerRegistration, err := informerForGVK.AddEventHandler(NewEventHandler(ctx, queue, &handler.EnqueueRequestForObject{}, nil).HandlerFuncs())
	if err != nil {
